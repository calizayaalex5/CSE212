...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: PersonQueue.Enqueue used Insert(0, person) instead of Add(person),
    //                  causing the queue to behave like a stack (LIFO),
    //                  returning Sue first instead of Bob.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: It didn't give the expected name, the stack didn't return the expected order
    ...
    // Defect(s) Found: 1) Enqueue usaba Insert(0,...) causando orden LIFO en vez de FIFO.
    //                  2) GetNextPerson no trataba valores negativos como turnos infinitos.
